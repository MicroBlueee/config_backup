# Generated by Powerlevel10k configuration wizard on 2022-01-28 at 02:44 CST.
...
() {
  ...
  # Status when some part of a pipe command fails and the overall status is also non-zero.
